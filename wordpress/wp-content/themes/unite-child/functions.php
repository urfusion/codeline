...
function filter_the_content($content) {
    ...
    $additional_content .= '<br /> <strong>Country: </strong>';

    foreach ($countries as $country) {
        $additional_content .= $country->name . ' ';
    }

    $genres = get_the_terms(get_the_ID(), 'genre');
    $additional_content .= '<br /> <strong>Genres: </strong>';

    foreach ($genres as $genre) {
        $additional_content .= $genre->name . ' ';
    }
    $additional_content .= '<br /><strong>Ticket Price: </strong>' . get_field("ticket_price", get_the_ID());
    $additional_content .= '<br /><strong>Release Date: </strong>' . get_field("release_date", get_the_ID());
